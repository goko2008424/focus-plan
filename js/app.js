...
(function () {
  ...
  function refreshStats() {
    ...
    // 📌 v99：来自「今天的基础任务」的副本**算完成率**（它就是今天要干完的一条真任务）
  ...
  function aboutModal() {
    const bodyHTML = '' +
      ...
      '<li><b>📌 基础任务现在能拆解（v99）</b>：「今天的基础任务」点 <b>▶</b> 之后，它就是' +
      '<b>今天的一条完整任务</b> —— 能主题拆解、能听课、能加小任务/任务组' +
      '（你说的"安排到今天的复习任务要拆解"就走这条）。<b>没点 ▶ 的</b>还是打勾就行的底线小事。</li>' +
