...
(function () {
  ...
  function aboutModal() {
    const bodyHTML = '' +
      ...
      '<li><b>⏱ 计时</b>：每次开始前填写「预计完成内容 + 预计用时」，完成后对比预计 vs 实际，暂停不计时。</li>' +
      '<li><b>🎉 奖励</b>：必须任务全部完成 → 保底奖励弹窗；三类全部完成 → 完美额外奖励。所有数值你自己定。</li>' +
      '<li><b>⭐ 积分</b>：每条理想/拓展任务都在任务后面直接标价（如弹琴30分钟 8分、弹琴1小时 5分，权重完全自己定），完成打勾即得积分；兑换表（多少分换什么）由你自定义，兑换即扣分。</li>' +
      '<li><b>📅 时间轴</b>：柳比歇夫式时间记录——任务计时自动生成记录，其余时间（吃饭/睡觉/游戏）手动点空白或拖动添加，让每一个小时都有据可查。</li>' +
      ...
      '<li><b>保底达成</b>：必须任务全部打勾 → 弹出奖励选择（加休闲时间 / 加积分，数值可临时改），然后决定继续理想任务、进拓展、还是提前收工。</li>' +
      ...
      '<p style="font-size:13.5px">任务时段 08:00–22:00 · 拓展时段 22:00–23:00 · 保底奖励 休闲+30分钟 或 积分+10 · 理想每条 +10 分 · 拓展每条 +5 分 · 完美奖励 休闲+30 或 积分+20 · 未完成顺延无惩罚 · 拓展可追加</p>' +
