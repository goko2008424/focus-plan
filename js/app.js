...
(function () {
  ...
  function switchView(v) {
    ...
    if (v === 'lecture' && App.lecture) App.lecture.render();
  ...
  function refreshAll() {
    ...
    if (App.lecture) App.lecture.render();
    refreshStats();
  }
