...
(function () {
  ...
  function aboutModal() {
    const bodyHTML = '' +
      ...
      '<li><b>⏰ 学习时段：什么时候学新、什么时候复习（v71）</b>：设置里能定一段「新知识时间」（默认 <b>08:00 – 16:00</b>，可以自己改），' +
      '首页最上面就会多一条：这段时间里写着「📘 新知识时间 · 到 16:00 结束，还有 3 小时 20 分」，还会告诉你今天的新知识任务推了几条；' +
      '过了这个点就变成「🔄 复习时间 · 新知识时间 明天 08:00 再开」。任务行上「📘 新知识」的徽标在复习时间里会变淡，提示你这条留到明天开头学更牢。' +
      '<b>完全不是硬性规定</b> —— 复习时间里照样能学新东西、能打勾、能计时，只是给你一个当下的参考；不想要就在设置里把开关关掉。</li>' +
